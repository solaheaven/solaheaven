...
public class Simulator
{
    ...
    private static final double CAMEL_CREATION_PROBABILITY = 0.14; 
    private static final double LION_CREATION_PROBABILITY = 0.10; 
    ...
    public Simulator(int depth, int width)
    {
        ...
        view.setColor(Camel.class, Color.RED);
